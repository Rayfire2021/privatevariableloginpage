...
label_password.place(relx=0.3,rely=0.3,anchor=CENTER)
...
input_captcha.place(relx=0.5,rely=0.7,anchor=CENTER)
...
class userDB():
    ...
    def showUser(self):
        ...
        label_show_password["text"] = "Password : "+self._password
